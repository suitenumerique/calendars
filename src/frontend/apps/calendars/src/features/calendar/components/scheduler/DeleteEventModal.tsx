  ...
  return (
    <Modal
      ...
      rightActions={
        <>
          ...
          <Button color="error" onClick={() => onConfirm(isRecurring ? selectedOption : undefined)}>
    ...
    >
      <div className="delete-modal__content">
        {isRecurring ? (
          <>
            <p className="delete-modal__message">{t("calendar.event.deleteRecurringPrompt")}</p>
            <div className="delete-modal__options">
              <label className="delete-modal__option">
                <input
                  ...
                  onChange={(e) => setSelectedOption(e.target.value as RecurringDeleteOption)}
                />
          ...
          <p className="delete-modal__message">{t("calendar.event.deleteConfirmMessage")}</p>
        )}
      </div>
    </Modal>
  );
